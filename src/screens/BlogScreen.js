...
const blogs = [
  {
    title:
      'Mastering the Pomodoro Technique: A Simple Way to Boost Productivity',
    description:
      'The Pomodoro technique has been a game-changer for many people trying to improve their time management. But how exactly does it work, and why is it so effective?\n' +
  ...
  },
  {
    ...
    description:
      "One of the most powerful features of the KTO app is the ability to customize your Pomodoro timer to fit your unique work style. But what’s the best setup for you? Here's a guide to help you tweak the timer for optimal results:\n" +
  ...
  },
  {
    ...
    description:
      'Time management isn’t just about checking off tasks—it’s about working smarter, not harder. By learning how to manage your time effectively, you can reduce stress, increase productivity, and even make more time for relaxation and self-care.\n' +
